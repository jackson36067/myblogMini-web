...
import { wxLoginAPI } from "@/apis/user";
import { useMemberStore } from "@/stores";
import type { LoginProfile } from "@/types/user";
import { ref } from "vue";
const memberStore = useMemberStore();
const user = ref<LoginProfile>({
  id: "",
  token: "",
  openid: "",
  nickName: "",
...
const wxLogin = () => {
  wx.getUserProfile({
    ...
    success: (result) => {
      ...
      user.value.avatar = userInfo.avatarUrl;
...
<template>
  <view class="viewport">
    <view class="logo">
      <image
        src="http://jackson1.oss-cn-beijing.aliyuncs.com/a61be1b7-f7b3-4027-8e18-930fab3bdeef.jpg"
      ></image>
    </view>
    <view class="login">
      <!-- 网页端表单登录 -->
      ...
      <!-- 小程序端授权登录 -->
      <button class="button phone" open-type="getPhoneNumber" @tap="wxLogin">
